...
public class milyController {
	...
	public String idcheckprocess(String id, String pw, HttpSession session) {
		...
		return dao.idcheckProcess(id, pw) ? "redirect:/jsp/index.jsp" : "redirect:/jsp/signin.jsp";
	}
	...
	public String readFunction(Model model,String code,String id,HttpSession session) {
