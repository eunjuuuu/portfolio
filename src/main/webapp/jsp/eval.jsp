			...
			<div class="w3-col m7">
					...
					<div class="w3-col m12">
						<div class="w3-card w3-round w3-white">
							<div class="w3-container w3-padding">
								<form
									action="/web/evalInsert.do?bookcode=${i.bookcode}&id=${id}"
									id="frm" method="post">
									<h6 class="w3-opacity">${i.bookname}책에 대한 ${id} 님의 한줄평을
										입력해주세요.</h6>
									...
									<c:forEach var="k" begin="1" end="5">
										<input type="checkbox" id="${k}" name="score"value="${k}" /> ${k}점 
									</c:forEach>
									</div>
				...
				<c:forEach items="${evalList}" var="j" varStatus="cnt">
					<div class="w3-container w3-card w3-white w3-round w3-margin">
						<span class="w3-right w3-opacity">작성자: ${j.id}&emsp;작성일:
							${j.writedate}</span>
						<h4 style="display: inline;">${j.bookname}</h4>
						&emsp;
						<c:forEach var="e" begin="1" end="${j.score}">
